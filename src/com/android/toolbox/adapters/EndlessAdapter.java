...
//	  }
  ...
  public void forceReload(boolean reload){
	  forceReload = reload;
  }
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
	Log.e("EndlessAdapter", "getView forceReload: " + forceReload + " keepOnAppending : " + keepOnAppending.get() + " position("+position+")" + " count("+super.getCount()+")" + " is pending view null ? "+pendingView);
	if (position == super.getCount() && keepOnAppending.get()) {
		if (pendingView == null || ((pendingView.getVisibility()==View.VISIBLE) && isForceReload())) {
			Log.e("EndlessAdapter", "creating pendingview");
			...
			if (runInBackground) {
				...
				try {
					Log.e("EndlessAdapter", "running cacheInBackground");

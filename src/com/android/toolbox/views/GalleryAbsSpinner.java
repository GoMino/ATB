 ...
 */
public abstract class GalleryAbsSpinner  extends GalleryAdapterView<SpinnerAdapter> {
	...
	public GalleryAbsSpinner(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public GalleryAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
	...
	void recycleAllViews() {
		...
		final GalleryAbsSpinner.RecycleBin recycleBin = mRecycler;

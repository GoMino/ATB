...
public abstract class GalleryAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(GalleryAdapterView<?> parent, View view, int position, long id);
    ...
    public interface OnItemLongClickListener {
         ...
         *
         * @param gallery The AbsListView where the click happened
         ...
         */
        boolean onItemLongClick(Gallery gallery, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(GalleryAdapterView<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(GalleryAdapterView<?> parent);
    }
	...
	class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (GalleryAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
             GalleryAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (GalleryAdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = GalleryAdapterView.this.onSaveInstanceState();
            }

...
public class CustomFragmentManager {
	...
	public Fragment getLastStackedFragment(int depth){

		if (mFragmentManager.getBackStackEntryCount()>0 && mFragmentManager.getBackStackEntryCount()>depth){
			BackStackEntry stackedEntry = mFragmentManager.getBackStackEntryAt(mFragmentManager.getBackStackEntryCount()-1-depth);
	...
	public Fragment getLastStackedFragment(){
		return getLastStackedFragment(0);
	};
